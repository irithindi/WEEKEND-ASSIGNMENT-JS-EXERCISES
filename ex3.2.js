...
// const busDrive=(array)=>array.flat()
//     let peopleAtStation=0;
//     for(i=0;i<array.length;i+2){
//         peopleAtStation=array[i]-array[i-1];
//         peopleLeft = +peopleAtStation
//         return peopleLeft
//     }

// console.log (busDrive([[2,0],[4,2],[1,0]]))

const busDrive = (arr) => {

    for (i = 0; i < arr.length; i++) {
        for (j = 0, total = arr[j]; j < arr[i].length; j++) {
            total -= arr[i];
            console.log(total)
        }
    }
